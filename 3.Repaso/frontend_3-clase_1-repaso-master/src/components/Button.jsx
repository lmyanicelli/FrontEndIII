...
/*const Button = ({defaultFrase,fraseUno,fraseDos,fraseTres,arregloDeFrases, onClick, fraseChuck}) => { 
    ...
    //refactorizo
    const Button = ({arregloDeFrases, onClick, fraseChuck}) => { 
        const [textoBoton, setTextoBoton] = useState(arregloDeFrases[0])
    
        const handleClick = () => {
            setTextoBoton(onClick(arregloDeFrases,textoBoton))
        }    
